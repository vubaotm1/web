...
-->
	...
	<table class="table table-bordered table-condensed">
              ...
              <tbody>
                <tr>
                  ...
                  <td>Tên sản phẩm<br>Carate : 22<br>Model : n/a</td>
                  <td> - </td>
                  <td>$50.00</td>
                  <td>
	...
	<a href="products.php" class="shopBtn btn-large"><span class="icon-arrow-left"></span> Tiếp tục mua hàng </a>
	<a href="login.php" class="shopBtn btn-large pull-right">Kế tiếp <span class="icon-arrow-right"></span></a>
